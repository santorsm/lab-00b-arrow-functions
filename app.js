...
// The "this" when joe.scope() is invoked is the contextual "this" of the Student object we are building

// 2. What is "this" when joe.scopeArrow() is invoked?
// The "this" when joe.scopeArrow() is invoked is the the global window object

// 3. Explain why "this" is different when an arrow function is used.
// "this" context is not reset within an arrow function. The value of "this" is the same as
// the "this" of enclosing scope. If there isn’t a non-arrow function scope surrounding, the this context
// will be, in the browser. If there isn’t a non-arrow function scope surrounding, the this context will be,      // in the browser, the global window object. This is due to arrow functions retaining the "this" value of the
// enclosing functional scope
